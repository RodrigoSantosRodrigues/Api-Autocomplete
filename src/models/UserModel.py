...
class UserModel(db.Model):
  ...
  @staticmethod
  async def get_all_users(): #obter todos os usuários do banco de dados 
    return UserModel.query.all()

  @staticmethod
  async def get_one_user(id): #obter um único usuário do db usando campo primary_key
    return UserModel.query.filter_by(id=id).first()
  
  @staticmethod
  async def get_user_by_email(value):
